...
@WebServlet("/AddBookss")
@MultipartConfig
public class AddBookss extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BookDtls b = new BookDtls(bname, author, price, category, status, fileName,seller);
		...
		if(f) {
			session.setAttribute("message","Book added for sale");
